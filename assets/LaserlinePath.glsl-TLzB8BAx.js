import{ES as xe,EN as Se,CX as m,Em as D,EV as Ve,CY as B,CV as l,gB as j,t_ as le,EQ as ye,DN as A,ut as Ce,iw as v,f$ as oe,bu as d,fo as U,g2 as H,FB as Le,gp as ce,DX as he,Dw as T,by as b,FC as de,fK as ue,bv as pe,g1 as Ae,f_ as Te,mw as Me,kk as $e,go as Re,fn as Ue,g6 as fe,CZ as ge,C_ as _e,_ as me,CN as ze,ct as G,gf as N,EO as Ie,qz as Oe,cy as qe,Du as Ne,DU as je,eD as o,CU as X,fG as Fe,bz as R,dz as We,eC as Pe,fF as z,um as Be,hw as He,E as Ge,dx as Xe,FD as ke,b as _,Df as S,EZ as Ze,E_ as k,FE as Ke,FF as Ye,lp as Je,E$ as c,FG as I,FH as Qe,CI as Z,gh as et,gj as tt,sE as it,gk as nt,gl as st,gm as at,m as M,c as rt,FI as lt,cv as K,eL as Y,g9 as J,ga as Q,oU as ot,oZ as ct,FJ as ht,oY as dt,oT as ut,fu as pt,bt as ee,Aw as ft,xI as gt,lc as _t,gr as te,FK as mt}from"./index-CfYeSufM.js";import{t as Pt,a as vt}from"./LineVisualElement-BWm41HKU.js";function ve(t,e){const i=t.fragment;i.include(xe),t.include(Se),i.uniforms.add(new m("globalAlpha",n=>n.globalAlpha),new D("glowColor",n=>n.glowColor),new m("glowWidth",(n,s)=>n.glowWidth*s.camera.pixelRatio),new m("glowFalloff",n=>n.glowFalloff),new D("innerColor",n=>n.innerColor),new m("innerWidth",(n,s)=>n.innerWidth*s.camera.pixelRatio),new Ve("depthMap",n=>{var s;return(s=n.depth)==null?void 0:s.attachment}),new B("normalMap",n=>n.normals)),i.code.add(l`vec4 blendPremultiplied(vec4 source, vec4 dest) {
...
return abs(dist);
}`),t.spherical){const n=(a,r,h)=>v(a,r.heightManifoldTarget,h.camera.viewMatrix),s=(a,r)=>v(a,[0,0,0],r.camera.viewMatrix);i.uniforms.add(new A("heightManifoldOrigin",(a,r)=>(n(g,a,r),s(x,r),oe(x,x,g),U(f,x),f[3]=H(x),f)),new Le("globalOrigin",a=>s(g,a)),new m("cosSphericalAngleThreshold",(a,r)=>1-Math.max(2,ce(r.camera.eye,a.heightManifoldTarget)*r.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),i.code.add(l`float globeDistancePixels(float posInGlobalOriginLength) {
